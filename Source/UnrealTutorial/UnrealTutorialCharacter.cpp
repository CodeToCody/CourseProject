...
AUnrealTutorialCharacter::AUnrealTutorialCharacter()
{
	...
	FirstPersonCameraComponent->bUsePawnControlRotation = true;						// always facing where the controller is
...
void AUnrealTutorialCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// 開鏡
	PlayerInputComponent->BindAction("ZoomIn", IE_Pressed, this, &AUnrealTutorialCharacter::ZoomIn);
	PlayerInputComponent->BindAction("ZoomIn", IE_Released, this, &AUnrealTutorialCharacter::StopZoom);
	...
	PlayerInputComponent->BindAxis(
		"MoveForward", 
		this, 
		&AUnrealTutorialCharacter::MoveForward);
	PlayerInputComponent->BindAxis(
		"MoveRight", 
		this, 
		&AUnrealTutorialCharacter::MoveRight);
	...
	// Sprint Setting
	PlayerInputComponent->BindAction("Sprint", IE_Pressed, this, &AUnrealTutorialCharacter::Sprint);
	PlayerInputComponent->BindAction("Sprint", IE_Released, this, &AUnrealTutorialCharacter::StopSprint);
}
...
void AUnrealTutorialCharacter::StopZoom() {
	if (auto firstPersonCamera = GetFirstPersonCameraComponent()) {
